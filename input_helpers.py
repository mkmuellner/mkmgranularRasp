...
def handle_keyboard_input(
    ...
    key = input("Press a key: ")  # Blocking input for key detection
    ...
    elif key == 'v':  # Increase random pitch variation
        random_pitch_variation += 0.1
        print(f"Increased random pitch variation to {random_pitch_variation}")
    elif key == 'c':  # Decrease random pitch variation
        random_pitch_variation = max(0, random_pitch_variation - 0.1)
        print(f"Decreased random pitch variation to {random_pitch_variation}")
